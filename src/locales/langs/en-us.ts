  ...
  page: {
    ...
    home: {
      ...
      projectNews: {
        title: 'Project News',
        moreNews: 'More News',
        desc1: 'Nautilus workstation is officially online!',
        desc2: 'Soybean Admin template migration completed, frontend-backend integration successful.',
        desc3: 'Nautilus is preparing Phase 1 account and permission system!',
        desc4: 'Nautilus multi-level memory system design is completed!',
        desc5: 'Nautilus Feishu communication bridge research is done!'
      },
